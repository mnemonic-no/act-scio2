...
async def test_sectors() -> None:
    ...
    nlpdata.pos_tag.tokens = [['The', 'DT'], ['Noughty', 'NNP'], ['Noo-Noo', 'NNP'], ['threat', 'NN'], ['group', 'NN'], ['sucks', 'VBZ'], ['up', 'RP'], ['tubby', 'JJ'], ['toast', 'NN'], ['.', '.'], ['The', 'DT'], ['Tinky', 'NNP'], ['Winky', 'NNP'], [',', ','], ['Dipsy', 'NNP'], [',', ','], ['Laa-Laa', 'NNP'], ['and', 'CC'], ['Poo', 'NNP'], ['adversary', 'JJ'], ['groups', 'NNS'], ['looks', 'VBZ'], ['sketchy', 'NNS'], ['.', '.']]

    nlpdata.content = ('The Noughty Noo-Noo threat group sucks up tubby toast. ' +
